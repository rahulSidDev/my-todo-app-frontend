...
import { todoCreate, todoGetAll, todoDelete, todoUpdate } from "../api/todos";
...
function Dashboard() {
    ...
    const newtodoCreateHandler = async (e) => {
        ...
        try {
            ...
            const res = await todoCreate(payload);
            fetchTodos();
    ...
    const deleteTodo = async (id) => {
        try {
            const rest = await todoDelete(id);
            fetchTodos();
        } catch (e) {
    ...
    const handleEditingTodo = async (id) => {
        try {
            const res = await todoUpdate(id, editedTodo);
            setEditState(null);
            setEditedTodo({
                title: "",
                description: "",
        ...
        <div className="min-w-screen min-h-screen flex justify-center items-center bg-slate-100">
            ...
            <div className="h-full w-[33%] p-5 bg-gray-50 rounded-xl flex flex-col items-center">
                ...
                <div className="w-full h-[20%]">
                    <div className="w-full h-[20%]">
                        <form
                            onSubmit={newtodoCreateHandler}
                            className="w-full flex flex-col py-2 gap-5 items-center"
                        >
                                        ...
                                        <>
                                            ...
                                            <td className="flex gap-5 py-1">
                                                <button
                                                    ...
                                                    className="px-3 py-1 rounded-sm bg-gray-100 text-gray-800 cursor-pointer"
                                                >
                                                    Cancel
                                                </button>
                                                <button
                                                    ...
                                                    className="px-3 py-1 rounded-sm bg-green-500 text-gray-800 cursor-pointer"
                                                >
                                                    Save
                                                </button>
                                            </td>
                                        ...
                                        <>
                                            ...
                                            <td className="flex gap-5 py-1">
                                                <button
                                                    ...
                                                    className="px-3 py-1 rounded-sm bg-red-500 text-gray-800 cursor-pointer"
                                                >
                                                    Delete
                                                </button>
                                                <button
